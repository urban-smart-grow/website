...
The tower can be powered with USB-C or alternatively by solar, for which another module is needed.
For building the solar module, please refer to the [build instructions found here](./aerotower/solar_module).
