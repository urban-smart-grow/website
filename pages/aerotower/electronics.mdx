...
Once you have loaded the code onto the XIAO, connect it to the pin headers found in the XIAO packaging. You can optionally solder them to ensure better hold.
